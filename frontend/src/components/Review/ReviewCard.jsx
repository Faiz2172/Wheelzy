...
import { FiUser, FiCalendar, FiCheckCircle, FiThumbsUp, FiEdit2, FiTrash2 } from 'react-icons/fi';
...
const ReviewCard = ({ review, onEdit, onDelete }) => {
  ...
  return (
    <div
      className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 overflow-hidden group cursor-pointer"
